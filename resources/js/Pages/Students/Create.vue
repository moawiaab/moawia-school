<template>
    ...
    >
        <q-card style="width: 800px; max-width: 80vw" title="إنشاء طالب جديد">
            <q-card-section>
                <div class="text-h6">إنشاء طالب جديد</div>
            </q-card-section>
            <q-separator />
                        ...
                        <template v-slot:after>
                            <div class="q-pa-sm">
                                <q-input
                                    filled
                                    clearable
                                    v-model="student.entry.password"
                                    label="كلمة السر"
                                    lazy-rules
                                    :rules="rules.required"
                                    type="password"
                                    :error-message="student.errors.password"
                                />
                                <q-input
                                    clearable
                                    filled
                                    v-model="
                                        student.entry.password_confirmation
                                    "
